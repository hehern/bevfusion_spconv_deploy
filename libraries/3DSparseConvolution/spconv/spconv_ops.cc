...
getIndicePairs(nv::Tensor indices,
  ...
  nv::Tensor indicePairs = nv::Tensor::create({2, kernelVolume, numAct}, nv::DataType::Int32);
  indicePairs.memset(-1);
  nv::Tensor indiceNum = nv::Tensor::create({kernelVolume}, nv::DataType::Int32);
  indiceNum.memset(0);

  auto gridSize = outputVolume;
  nv::Tensor gridOut = nv::Tensor::create({gridSize}, nv::DataType::Int32);
  gridOut.memset(-1);
